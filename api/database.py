...
def migrate_vale_disabled_entries():
    """Add vale_disabled_entries column to user_settings."""
    try:
        with engine.begin() as conn:
            conn.execute(text("ALTER TABLE user_settings ADD COLUMN vale_disabled_entries TEXT"))
    except Exception:
        pass

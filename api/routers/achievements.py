...
def get_achievements(db: Session = Depends(get_db)):
    ...
    _h("mirror",        "mirror",        "Mirror",               "Your scene count and codex entry count are nearly equal. For every scene you've written, a world-piece exists to fill it. Balance is the rarest writing discipline — most tilt one way or the other. Not you.",                                                                                                "codex",    2, "mirror_condition",      1)
    _h("comeback_kid",  "comeback_kid",  "Comeback Kid",         "A gap of 30 days or more — then you came back. Dostoevsky stood before a firing squad at 28, was pardoned at the last moment, and spent 32 more years writing. A month away from the page is nothing.",                                                                                                       "streaks",  2, "comeback_gap",          30)
    _h("perfect_month", "perfect_month", "Perfect Month",        "Every single day of a calendar month. Anthony Trollope wrote 49 novels by sitting down at 5:30 each morning and producing 250 words every fifteen minutes for three hours — including Christmas Day. You belong in his company.",                                                                              "streaks",  4, "perfect_month",         1)
    _h("omnivore",      "omnivore",      "The Omnivore",         "Character, location, item, relic, lore — all five. 'The story-maker proves a successful sub-creator. He makes a Secondary World which your mind can enter.' — Tolkien. Yours is properly furnished.",                                                                                                         "codex",    2, "all_codex_types",       5)
